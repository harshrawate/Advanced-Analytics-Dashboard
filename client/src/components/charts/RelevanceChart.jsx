...
const RelevanceChart = ({ data }) => {
  ...
  useEffect(() => {
    ...
    g.selectAll(".bar")
      ...
      .attr("y", height)
      .attr("height", 0)
      .attr("fill", (d) => colorScale(d.avgRelevance))
      .attr("rx", 6)
      .attr("ry", 6)
      ...
      .on("mouseover", function (event, d) {
        ...
        tooltip
          .html(`
            ...
            <div>Avg Relevance: <span class="font-bold">${d.avgRelevance.toFixed(2)}</span></div>
      ...
      .duration(1000)
      .delay((d, i) => i * 150)
      .attr("y", (d) => y(d.avgRelevance))
      .attr("height", (d) => height - y(d.avgRelevance))
